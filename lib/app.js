(function() {
  var BrowserWindow, CND, SegfaultHandler, alert, app, badge, debug, echo, error, help, info, ipc, log, njs_fs, options, rpr, urge, warn, whisper, windows;
  ...
  try {
    ...
    if (error['message'] !== "Cannot find module 'segfault-handler'") {
      throw error;
    }
  }
